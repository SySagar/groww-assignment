      ...
      <table>
        <tbody>
          ...
          <tr>
            ...
            <td class={style.valueAddition}>
              {currencySymbol} {(itemCount === 0 ? 0 : shippingCost).toFixed(2)}
            </td>
          </tr>
          <tr>
            <th>Tax (5% GST)</th>
            <td class={style.valueAddition}>
              {currencySymbol} {discountValue(priceTotal).toFixed(2)}
            </td>
          </tr>
        </tbody>
      </table>
        ...
        <tbody>
          <tr className={style.total}>
            ...
            <td className={style.totalPrice}>
              ...
              {(itemCount === 0
                ? 0
                : priceTotal + shippingCost + discountValue(priceTotal)
              ).toFixed(2)}
            </td>
          </tr>
        </tbody>
